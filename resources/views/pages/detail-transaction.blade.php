...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <form action="{{ route('admin.transactions.add', $dataTransaction->id) }}" method="POST">
                        ...
                        <tbody>
                            <tr>
                                <td>Nama : {{ $transactionItems->user->first_name }} {{ $transactionItems->user->last_name }}, <br> Alamat : {{ $dataTransaction->formattedAddress }} <br> No.
                                    Telepon : {{ $transactionItems->user->phone_number }} <br>
                                    ...
                                    <br> Notes : {{ $dataTransaction->notes }}
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="number" name="ongkir" value="" min="1"
                                            class="form-control" style="width: 100px;"
                                            oninput="updateTotalPrice({{ $dataTransaction->total_price }})"
                                            id="autoSubmitForm">
                                    </div>
                                </td>
                            </tr>
            ...
            <a href="{{ route('admin.transactions.exportPdf', $dataTransaction->id) }}" class="btn btn-primary">Print
                PDF</a>
        </div>
    ...
    <script>
        function updateTotalPrice(totalPrice) {
            // Your logic to update total price here
